        ...
        <div className="relative overflow-hidden">
          <div className={`flex space-x-8 ${hoveredClient !== null ? 'animate-marquee-paused' : 'animate-marquee-infinite'}`}>
            {infiniteClients.map((client, index) => (
              ...
              >
                <div className={`${client.bgColor} rounded-xl shadow-card hover:shadow-glow transition-all duration-500 p-4 flex flex-col items-center justify-center h-full relative overflow-hidden`}>
                  {/* Background Pattern */}
                  ...
                  {hoveredClient === index && (
                    <div className="relative z-10 text-center text-white animate-fade-in">
                      ...
                      <div className="flex items-center justify-center space-x-4 text-xs">
                        ...
                        {/* Delivery Time */}
                        <div className="flex items-center space-x-1">
                          <span className="opacity-75">Delivered in</span>
